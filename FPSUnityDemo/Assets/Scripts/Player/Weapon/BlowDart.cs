...
public class BlowDart : NetworkBehaviour
{
    [Header("Information")]
    ...
    [Tooltip("The Camera that is being used for trajctory calculations")]
    public Camera weaponCamera;
    [Tooltip("where the bullet will move towrds at first from the muzzle")]
    ...
    [Tooltip("The projectile prefab game object")]
    ...
    void HandleShoot()
    {
        ...
        for (int i = 0; i < bulletsPerShotFinal; i++)
        {
            ...
            // Vector3 shotDirection = GetShotDirectionWithinSpread(weaponCamera.transform);
            // Vector3 spawnLocation = weaponCamera.transform.position  + (weaponCamera.transform.forward);
            // ProjectileBase newProjectile = Instantiate(projectilePrefab, spawnLocation, Quaternion.LookRotation(shotDirection));
